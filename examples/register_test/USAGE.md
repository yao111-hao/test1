...
| `-p, --pcie_resource` | PCIe资源文件路径 | `-p /sys/bus/pci/devices/0000:d8:00.0/resource2` |
...
```bash
sudo ./register_test -p /sys/bus/pci/devices/0000:d8:00.0/resource2 -a 0x102000 -r -V
```

### 6. 调试模式

```bash
sudo ./register_test -p /sys/bus/pci/devices/0000:d8:00.0/resource2 -a 0x102000 -r -g
```
...
# 指定PCIe资源路径
sudo ./test_registers.sh -p /sys/bus/pci/devices/0000:d8:00.0/resource2 -v
```
...
# 使用CPU亲和性运行
taskset -c 1,3,5,7 sudo ./register_test -p /sys/bus/pci/devices/0000:d8:00.0/resource2 -a 0x102000 -r
```
